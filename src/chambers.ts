...
export const CHAMBERS: Chamber[] = [
  {
    ...
    bench: { x: -10, z: 19 },
    color: "#bddbcc",
    intro: "You're awake. I'm ASTER. Most of the station is still asleep.",
    hint: "Join the two open contacts.",
    restored: "Light. And a door. Let's see how far that gets us.",
    tools: ["wire"],
  ...
  },
  {
    ...
    restored: "Contact made. I can hear the ventilation again.",
    tools: ["wire"],
  ...
  },
  {
    ...
    color: "#aacbdc",
    intro:
      "The repair drones left their parts. You'll have to make the next light.",
    hint: "Place a battery and a bulb. Give them a complete loop.",
    restored: "Your first circuit. The station has a pulse now.",
  ...
  },
  {
    ...
    restored: "Two lights in one path. The living quarters are waking up.",
    formula: "series",
    tools: ["wire", "bulb"],
  ...
  },
  {
    ...
    restored:
      "An independent path. That's how I stayed awake. Now the station can, too.",
    formula: "parallel",
    tools: ["wire", "bulb"],
