import type { ChamberId as MissionId } from "../chambers.ts";
...
export const PLAYER_KEY = "signal.asterion.chambers.player.v1";
export const SPAWN: Player = { x: -10, z: 23, yaw: 0, pitch: 0.015 };
